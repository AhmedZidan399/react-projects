    ...
    return (
        <div>
            <TextExpander>
                ...
                fiction,
                but believe it or not, space travel is a real thing. Humans and
                robots
                are constantly venturing out into the cosmos to uncover its
                secrets and
            ...
            >
                ...
                stepped
                foot on the moon or when rovers were sent to roam around on
                Mars.
            </TextExpander>
            ...
            <TextExpander expanded={ true } className="box">
                ...
                universe and
                have inspired future generations to keep reaching for the stars.
                Space
...
function TextExpander({
    ...
    return <div className={ className }>
        ...
        <button style={ { color: buttonColor } } onClick={ handleExpanded }>
            { expandedState
                ? collapseButtonText
                : expandButtonText
            }
